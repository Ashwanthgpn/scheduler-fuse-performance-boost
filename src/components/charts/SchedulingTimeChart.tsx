...
const SchedulingTimeChart = ({ selectedAlgorithms }: SchedulingTimeChartProps) => {
  const data = performanceData.schedulingTime;
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <XAxis dataKey="name" />
        <YAxis label={{ value: 'ms', position: 'insideLeft', angle: -90 }} />
